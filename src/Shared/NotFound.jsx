    ...
    <div className="flex items-center justify-center max-w-2xl mx-auto h-screen bg-secondary text-primary">
      <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-lg my-4">The page you are looking for might have been removed, had its name changed, or is temporarily unavailable.</p>
          <Link to="/" className="bg-secondary text-primary  underline">
            <Button variant={"link"} effect={"hoverUnderline"} className="text-xl pl-0"> Go to Home</Button>
          </Link>
        </div>
      </div>
    </div>
