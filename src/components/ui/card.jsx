        ...
        <div className="flex justify-between items-center">
          {memberData.position === "Team Leader" ? (
            ...
            memberData.google_scholar && (
              <a href={memberData.google_scholar} target="_blank" rel="noopener noreferrer" className="group flex font-light rounded-md items-center py-1 px-2 bg-primary border border-primary text-secondary hover:bg-secondary hover:text-primary  transition-all duration-300">
                Contact
